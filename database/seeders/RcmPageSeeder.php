    ...
    public function run(): void
    {
        $rows = [
            ...
            [
                ...
                'image_url'=> null,
                'metadata' => json_encode([
                    'badges' => ['Certified Coders', 'HIPAA Compliant', 'US-Based Team', 'Industry-Leading Clean Claim Rate', 'Pay-For-Paid Model'],
                ]),
                'order'    => 2,
            ],
            [
                ...
                'subtitle' => 'We help practices achieve significant revenue growth. Claim your FREE practice audit to learn more.',
                'content'  => null,
                'image_url'=> null,
                'metadata' => null,
                'order'    => 3,
